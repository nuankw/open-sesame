...
if options.mode in ["train", "refresh"]:
    ...
    sys.stderr.write("Printing output in CoNLL format to {}\n".format(out_conll_file))
    print("type of instances: {}\ntype of predictions: {}".format(type(instances), type(predictions)))
    print("length of instances: {}\nlength of predictions: {}".format(len(instances), len(predictions)))
    print("first element of instances: {}\n first element of predictions: {}".format(instances[0], predictions[0]))
    sys.exit(2)
