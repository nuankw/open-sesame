...
class Expression(object): #{{{
  ...
  # def scalar_value(self, recalculate=False): return 0.0  # the original code
  def scalar_value(self, recalculate=False): return 321.654 # changed to test if loss=0 bug is triggered by this
